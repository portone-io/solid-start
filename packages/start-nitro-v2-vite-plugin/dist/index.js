                        ...
                        if (file.type === "chunk") {
                            if (file.isEntry) {
                                if (entryFile !== undefined) {
                                    this.error(`Multiple entry points found for service "${this.environment.name}". Only one entry point is allowed.`);
                                }
...
export async function buildNitroEnvironment(nitro, build) {
    await prepare(nitro);
